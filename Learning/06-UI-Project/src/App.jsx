  ...
  const users = [
    {
      ...
      intro: 'Every challenge is an opportunity to create something meaningful and unforgettable.',
      color:'royalblue',
      tag: 'Satisfied'
    },
    {
      ...
      color:'lightseagreen',
      intro: 'We transform bold ideas into experiences that inspire and leave lasting impressions.',
      tag: 'Underserved'
    },
    {
      ...
      color:'orange',
      intro: 'Passion, creativity, and dedication come together to build exceptional results.',
      tag: 'Underbanked'
    },
    {
      ...
      color:'pink',
      intro: 'Great things happen when innovation meets purpose and people work together.',
      tag: 'Underprofession'
    },
    {
      ...
      intro:'Our journey is driven by curiosity, ambition, and a desire to improve.',
      color:'black',
      tag:'Average'
    }
  ]
